...
public static int ileNieparzystych(int tab[])
{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("liczby patrzyste: "+ileParzystych(tab));
        System.out.println("liczby dodatnie: "+ileDodatnich(tab));
        System.out.println("liczby ujemne: "+ileUjemnych(tab));
        System.out.println("ilość zer: "+ileZerowych(tab));
        System.out.println("ile maks liczb: "+ileMaksymalnych(tab));
